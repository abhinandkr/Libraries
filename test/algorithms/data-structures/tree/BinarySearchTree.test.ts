...
describe('Binary Search Tree', function() {
  ...
  it('should do pre order traversal', function() {
    expect(binarySearchTree.preOrderTraversal()).toEqual([12, 10, 11, 10.5, 11.5, 13])
  })
  it('should do in order traversal', function() {
    expect(binarySearchTree.inOrderTraversal()).toEqual([10, 10.5, 11, 11.5, 12, 13])
  })
  it('should do post order traversal', function() {
    expect(binarySearchTree.postOrderTraversal()).toEqual([10.5, 11.5, 11, 10, 13, 12])
  })
  it('should do level order traversal', function() {
    expect(binarySearchTree.levelOrderTraversal()).toEqual([12, 10, 13, 11, 10.5, 11.5])
  })
  it('should delete value in BST', function() {
    binarySearchTree.delete(11)
    expect(binarySearchTree.search(11)).toEqual(false)
    expect(binarySearchTree.inOrderTraversal()).toEqual([10, 10.5, 11.5, 12, 13])
  })
})
